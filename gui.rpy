...
define gui.text_font = "fonts/GrapeSoda.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "fonts/GrapeSoda.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "fonts/GrapeSoda.ttf"

## Размер нормального текста диалога.
define gui.text_size = 45

## Размер имён персонажей.
define gui.name_text_size = 72

## Размер текста в пользовательском интерфейсе.
define gui.interface_text_size = 72

## Размер заголовков в пользовательском интерфейсе.
define gui.label_text_size = 72

## Размер текста на экране уведомлений.
define gui.notify_text_size = 72
...
define gui.main_menu_background = "images/City_Menu.png"
